        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="bg-orange-50 border-l-4 border-orange-500 p-6 rounded-r-lg">
              ...
              <p className="text-gray-700 mt-2">- Jean SEMEN, Fondateur</p>
            </div>
          </div>

          <div>
            <div className="relative">
              <div className="aspect-[4/3] bg-gradient-to-br from-slate-200 to-slate-300 rounded-2xl overflow-hidden shadow-2xl">
                <img
