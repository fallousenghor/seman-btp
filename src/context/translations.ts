...
export const translations: Translations = {
  ...
  'projects.3.title': { fr: 'Entrepôt TIS HYDROCARBURES', en: 'TIS HYDROCARBONS warehouse' },
  'projects.3.category': { fr: 'Construction', en: 'Construction' },
  'projects.3.description': { fr: 'Projet de réalisation des dallages de l\'entrepôt TIS HYDROCARBURES', en: 'TIS HYDROCARBURES warehouse flooring project' },
  'projects.4.title': { fr: 'CBAO de Dakar pompiers', en: 'CBAO of Dakar pompiers' },
  'projects.4.category': { fr: 'Rénovation', en: 'Renovation' },
  'projects.4.description': { fr: 'Projet de rénovation de la bank CBAO de Dakar pompiers', en: 'Renovation of a Haussmannian apartment while preserving its character' },
  'projects.5.title': { fr: 'Conception eglise', en: 'Church conception' },
  'projects.5.category': { fr: 'Conception', en: 'Conception' },
  'projects.5.description': { fr: 'Projet de conception d\'une église', en: 'Design project for a church' },
  'projects.6.title': { fr: 'SUNU BANK de Maristes', en: 'SUNU BANK of Maristes' },
  'projects.6.category': { fr: 'Rénovation', en: 'Renovation' },
